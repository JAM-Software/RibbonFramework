...
typedef System::TMetaClass* TUICommandClass;
...
private:
	...
	System::DynamicArray<System::Uitypes::TColor> __fastcall GetStandardColors(void);
	void __fastcall SetStandardColors(const System::DynamicArray<System::Uitypes::TColor> Value);
	System::DynamicArray<System::UnicodeString> __fastcall GetStandardColorTooltips(void);
	void __fastcall SetStandardColorTooltips(const System::DynamicArray<System::UnicodeString> Value);
	System::DynamicArray<System::Uitypes::TColor> __fastcall GetThemeColors(void);
	void __fastcall SetThemeColors(const System::DynamicArray<System::Uitypes::TColor> Value);
	System::DynamicArray<System::UnicodeString> __fastcall GetThemeColorTooltips(void);
	void __fastcall SetThemeColorTooltips(const System::DynamicArray<System::UnicodeString> Value);
...
public:
	...
	__property System::DynamicArray<System::Uitypes::TColor> StandardColors = {read=GetStandardColors, write=SetStandardColors};
	__property System::DynamicArray<System::UnicodeString> StandardColorTooltips = {read=GetStandardColorTooltips, write=SetStandardColorTooltips};
	...
	__property System::DynamicArray<System::Uitypes::TColor> ThemeColors = {read=GetThemeColors, write=SetThemeColors};
	__property System::DynamicArray<System::UnicodeString> ThemeColorTooltips = {read=GetThemeColorTooltips, write=SetThemeColorTooltips};
