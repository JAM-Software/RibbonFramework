...
// (DO NOT EDIT: machine generated header) 'UIRibbonApi.pas' rev: 30.00 (Windows)
...
#pragma pack(push,1)
struct DECLSPEC_DRECORD TUIPropertyKey
{
public:
	GUID FmtId;
	unsigned PId;
	static bool __fastcall _op_Equality(const TUIPropertyKey &A, const TUIPropertyKey &B);
	static bool __fastcall _op_Equality(const TUIPropertyKey &A, const _tagpropertykey &B);
	static bool __fastcall _op_Inequality(const TUIPropertyKey &A, const TUIPropertyKey &B);
	static bool __fastcall _op_Inequality(const TUIPropertyKey &A, const _tagpropertykey &B);
};
#pragma pack(pop)


typedef TUIPropertyKey *PUIPropertyKey;
...
{
	virtual HRESULT __stdcall GetValue(const TUIPropertyKey &Key, /* out */ tagPROPVARIANT &Value) = 0 ;
};
...
__interface  INTERFACE_UUID("{F4F0385D-6872-43A8-AD09-4C339CB3F5C5}") IUIFramework  : public System::IInterface 
{
	...
	virtual HRESULT __stdcall GetUICommandProperty(unsigned CommandId, const TUIPropertyKey &Key, /* out */ tagPROPVARIANT &Value) = 0 ;
	virtual HRESULT __stdcall SetUICommandProperty(unsigned CommandId, const TUIPropertyKey &Key, const tagPROPVARIANT &Value) = 0 ;
	virtual HRESULT __safecall InvalidateUICommand(unsigned CommandId, _UIInvalidations Flags, PUIPropertyKey Key) = 0 ;
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Enabled;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_LabelDescription;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Keytip;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Label;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_TooltipDescription;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_TooltipTitle;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_LargeImage;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_LargeHighContrastImage;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_SmallImage;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_SmallHighContrastImage;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_CommandId;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ItemsSource;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Categories;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_CategoryId;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_SelectedItem;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_CommandType;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ItemImage;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_BooleanValue;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_DecimalValue;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_StringValue;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_MaxValue;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_MinValue;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Increment;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_DecimalPlaces;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FormatString;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_RepresentativeString;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_Family;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_Size;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_Bold;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_Italic;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_Underline;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_Strikethrough;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_VerticalPositioning;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_ForegroundColor;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_BackgroundColor;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_ForegroundColorType;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_BackgroundColorType;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_ChangedProperties;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_FontProperties_DeltaSize;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_RecentItems;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Pinned;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Color;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ColorType;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ColorMode;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ThemeColorsCategoryLabel;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_StandardColorsCategoryLabel;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_RecentColorsCategoryLabel;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_AutomaticColorLabel;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_NoColorLabel;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_MoreColorsLabel;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ThemeColors;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_StandardColors;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ThemeColorsTooltips;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_StandardColorsTooltips;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Viewable;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_Minimized;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_QuickAccessToolbarDock;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_ContextAvailable;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_GlobalBackgroundColor;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_GlobalHighlightColor;
extern DELPHI_PACKAGE TUIPropertyKey UI_PKEY_GlobalTextColor;
...
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromBoolean(const TUIPropertyKey &Key, const bool Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromUInt32(const TUIPropertyKey &Key, const unsigned Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromString(const TUIPropertyKey &Key, const System::UnicodeString Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromDecimal(const TUIPropertyKey &Key, const tagDEC &Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromInterface(const TUIPropertyKey &Key, const System::_di_IInterface Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromImage(const TUIPropertyKey &Key, const _di_IUIImage Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIInitPropertyFromIUnknownArray(const TUIPropertyKey &Key, const Winapi::Activex::PSafeArray Value, /* out */ tagPROPVARIANT &PropVar);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToBoolean(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ bool &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToUInt32(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ unsigned &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToString(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ System::UnicodeString &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToStringAlloc(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ System::UnicodeString &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToDecimal(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ tagDEC &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToInterface(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ System::_di_IInterface &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToImage(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ _di_IUIImage &Value);
extern DELPHI_PACKAGE HRESULT __fastcall UIPropertyToIUnknownArrayAlloc(const TUIPropertyKey &Key, const tagPROPVARIANT &PropVar, /* out */ Winapi::Activex::PSafeArray &Value);
}	/* namespace Uiribbonapi */
