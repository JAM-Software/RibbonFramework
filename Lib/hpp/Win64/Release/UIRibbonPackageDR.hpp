...
// (DO NOT EDIT: machine generated header) 'UIRibbonPackageDR.dpk' rev: 32.00 (Windows)
...
#include <SysInit.hpp>
#include <UIRibbon.hpp>
#include <UIRibbonCommands.hpp>
#include <UIRibbonActions.hpp>
...
namespace Uiribbonpackagedr
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Uiribbonpackagedr */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_UIRIBBONPACKAGEDR)
using namespace Uiribbonpackagedr;
#endif
#pragma pack(pop)
#pragma option pop
