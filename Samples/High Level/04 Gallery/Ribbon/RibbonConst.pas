...
const // Resource.h
  ...
  IDB_RECTANGLE_96            = 500;
  IDB_RECTANGLE_120           = 501;
  IDB_RECTANGLE_144           = 502;
  IDB_RECTANGLE_192           = 503;
  IDB_ROUNDED_RECTANGLE_96    = 504;
  IDB_ROUNDED_RECTANGLE_120   = 505;
  IDB_ROUNDED_RECTANGLE_144   = 506;
  IDB_ROUNDED_RECTANGLE_192   = 507;
  IDB_ELLIPSE_96              = 508;
  IDB_ELLIPSE_120             = 509;
  IDB_ELLIPSE_144             = 510;
  IDB_ELLIPSE_192             = 511;
  ...
  IDS_RECTANGLE               = 528;
  IDS_ELLIPSE                 = 529;
  IDS_ROUNDED_RECTANGLE       = 530;
  IDS_DIAMOND                 = 531;

  IDS_BORDER_NONE             = 532;
  IDS_BORDER_SOLID            = 533;
  IDS_BORDER_DASH             = 534;

  IDS_BORDERSIZE_1            = 535;
  IDS_BORDERSIZE_3            = 536;
  IDS_BORDERSIZE_5            = 537;

  IDS_LAYOUT_1                = 538;
  IDS_LAYOUT_2                = 539;
  IDS_LAYOUT_3                = 540;

  IDS_SIZE_CATEGORY           = 541;
  IDS_COLOR_CATEGORY          = 542;

  IDS_INVALID_SIZE_MESSAGE    = 543;
  IDS_INVALID_SIZE_TITLE      = 544;
